...
public class PlayerManager : FindObject
{
        ...
        if (PlayerPrefs.GetFloat("Gold") > 300)
        {
            ...
            switch(c)
            {
                case 0:
                    ...
                    break;
                case 1:
                    GameObject game1 = Instantiate(h_PlayerPrefab, new Vector3(-20, -5, 0), Quaternion.identity);
                    break;
                case 2:
                    GameObject game2 = Instantiate(h_PlayerPrefab, new Vector3(-18, -4, 0), Quaternion.identity);
                    break;
                case 3:
                    GameObject game3 = Instantiate(h_PlayerPrefab, new Vector3(-20, -5, 0), Quaternion.identity);
                    break;
                case 4:
                    GameObject game4 = Instantiate(h_PlayerPrefab, new Vector3(-20, -5, 0), Quaternion.identity);
                    break;
                case 5:
                    GameObject game5 = Instantiate(h_PlayerPrefab, new Vector3(-20, -5, 0), Quaternion.identity);
                    break;
    ...
    public void OnButtonPlayer2()
    {
        ...
        if (gameObject != null)
        {
            playerLife = gameObject.GetComponent<PlayerLife>();
            AudioManager.instance.Play("Button");
            h_updragePlayer[5].SetActive(true);
        }
        else
        {
            playerLife = null;
